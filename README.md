...
This project aims to provide a data analysis solution for Formula-1 race results using Azure Databricks. The data is sourced from ergast.com, a website dedicated to Formula 1 statistics, and is stored in Azure Datalake. By utilizing Databricks, this repository enables you to perform insightful analysis, visualize trends, and gain valuable insights from the Formula-1 race results. We have analyzed the drivers champion and constructor champion by loading the data from Ergast to Azure DataLake Gen2 storage. Data transformation and analysis was performed using Azure Databricks. The entire process is orchestrated using Azure Data Factory.
